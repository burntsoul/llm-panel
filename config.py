...
class Settings:
    ...
    def __init__(self) -> None:
        ...
        self.GPU_WATCHDOG_OVER_TARGET_KP = float(gpu_watchdog_curve["over_target_kp"].value)
        ...
        self.GPU_WATCHDOG_DERIVATIVE_LOOKAHEAD_SECONDS = float(gpu_watchdog_curve["derivative_lookahead_seconds"].value)
        self.GPU_WATCHDOG_DERIVATIVE_SMOOTHING_ALPHA = float(gpu_watchdog_curve["derivative_smoothing_alpha"].value)
        self.GPU_WATCHDOG_COOLDOWN_RELEASE_BELOW_TARGET_C = float(gpu_watchdog_curve["cooldown_release_below_target_c"].value)
        self.GPU_WATCHDOG_COOLDOWN_RELEASE_GPU_UTIL_PERCENT = float(gpu_watchdog_curve["cooldown_release_gpu_util_percent"].value)
